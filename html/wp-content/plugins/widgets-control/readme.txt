...
For even more flexible control, use [Widgets Control Pro](http://www.itthinx.com/shop/widgets-control-pro/) which provides freely definable additional sidebars.
...
- [Affiliates](http://wordpress.org/plugins/affiliates/)
- [Decent Comments](http://wordpress.org/plugins/decent-comments/)
...
- [Elementor](http://wordpress.org/plugins/elementor/)
